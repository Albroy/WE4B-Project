...
export class CardService {
  ...
  getCards()  {
    this.Array.push(new Card(1,0,"../assets/test.jpg","UTBM",9.99,0,"Lorem, ipsum dolor sit amet consectetur adipisicing elit. Veniam quidem eaque ut eveniet aut quis rerum."));
